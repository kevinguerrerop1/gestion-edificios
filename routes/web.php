...
Route::middleware(['auth'])->group(function () {
    Route::middleware(['role:admin'])->group(function () {
        ...
        Route::get('/reportes/checkouts', [ReporteController::class, 'checkouts'])->name('reportes.checkouts');
        Route::get('/reportes/checkouts/pdf', [ReporteController::class, 'checkoutsPdf'])->name('reportes.checkouts.pdf');
        Route::get('/checkouts/{id}/pdf', [CheckoutController::class, 'pdf'])->name('checkouts.pdf');
        Route::get('/reportes/checkouts/excel', [ReporteController::class, 'checkoutsExcel'])->name('reportes.checkouts.excel');
        Route::delete('/checkouts/{id}', [CheckoutController::class, 'destroy'])->name('checkouts.destroy');
        Route::get('/checkouts/papelera', [CheckoutController::class, 'papelera'])->name('checkouts.papelera');
        Route::post('/checkouts/{id}/restaurar', [CheckoutController::class, 'restaurar'])->name('checkouts.restaurar');
        Route::delete('/checkouts/{id}/force', [CheckoutController::class, 'forceDelete'])->name('checkouts.forceDelete');
        ...
        Route::post('checkouts/{id}/articulos', [CheckoutController::class, 'agregarArticulos'])->name('checkouts.agregarArticulos');
        Route::post('checkouts/{id}/finalizar', [CheckoutController::class, 'finalizar'])->name('checkouts.finalizar');
        Route::post('checkouts/{id}/estado', [CheckoutController::class, 'cambiarEstado'])->name('checkouts.estado');
        Route::post('checkouts/{id}/observaciones', [CheckoutController::class, 'agregarObservacion'])->name('checkouts.observaciones');
        Route::get('checkouts/{id}/historial', [CheckoutController::class, 'historial'])->name('checkouts.historial');

        Route::post('checkouts/{id}/documentos', [CheckoutController::class, 'guardarDocumentos'])->name('checkouts.documentos');
    ...
    Route::get('checkouts/cerrados', [CheckoutController::class, 'cerrados'])->name('checkouts.cerrados');
