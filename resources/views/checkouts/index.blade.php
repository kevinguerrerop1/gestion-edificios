...
@section('content')
    ...
    <div class="container py-4">
        ...
        {{-- TABLA CON COLUMNAS DINÁMICAS POR ROL --}}
                            ...
                            <td class="text-center">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <li><a class="dropdown-item" href="{{ route('checkouts.show', $c->id) }}">👁
                                                Ver</a></li>
                    ...
                    <div class="modal-content">
                        <div class="modal-header bg-dark text-white">
                            <h5 class="modal-title">
                                📑 Cotizaciones - Check-Out #{{ $c->id }} ({{ $c->edificio->nombre ?? '-' }} -
                                Dpto. {{ $c->bloque }})
                            </h5>
                                                ...
                                                <div class="accordion-body">
                                                    ...
                                                    <div class="table-responsive mb-3">
                                                        <table class="table table-sm table-bordered align-middle">
                                                            ...
                                                            <tfoot>
                                                                <tr>
                                                                    <td colspan="4" class="text-end fw-bold">Subtotal:
                                                                    </td>
                                                                    <td class="text-end fw-bold">
                                                                        ${{ number_format($cot->subtotal, 0, ',', '.') }}
                                                                    </td>
                                                                </tr>
                                                                <tr>
