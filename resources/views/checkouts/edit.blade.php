                    ...
                    <div class="col-md-4">
                        ...
                        <select name="edificio_id" class="form-select shadow-sm" required>
                            @foreach($edificios as $e)
                                <option value="{{ $e->id }}" {{ $checkout->edificio_id == $e->id ? 'selected' : '' }}>
                                    {{ $e->nombre }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        @if($checkout->pdf_solicitud)
                            <a href="{{ asset('checkout/'.$checkout->pdf_solicitud) }}"
                               target="_blank"
                               class="btn btn-light border w-100 mb-2 d-flex justify-content-center align-items-center gap-2">
                                📄 Ver PDF actual
                            </a>
                        @endif
                    ...
                    <div class="col-md-6">
                        ...
                        @if($checkout->pdf_entrega)
                            <a href="{{ asset('checkout/'.$checkout->pdf_entrega) }}"
                               target="_blank"
                               class="btn btn-light border w-100 mb-2 d-flex justify-content-center align-items-center gap-2">
                                📄 Ver PDF actual
                            </a>
