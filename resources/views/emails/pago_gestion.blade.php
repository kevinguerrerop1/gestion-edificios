        ...
        <tr>
            <td align="center">
                ...
                <table width="600" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td
                            style="background:#1f4e78; padding:18px; text-align:center;
                    ...
                    <tr>
                        <td style="padding:25px; color:#333333; font-size:14px;">
                            ...
                            <div
                                style="background:#eef3f8; border-left:5px solid #1f4e78;
                    ...
                    <tr>
                        <td
                            style="background:#f0f2f5; padding:15px; text-align:center;
